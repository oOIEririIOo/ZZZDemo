...
public class UnagiHavenAttackState : UnagiStateBase
{
    //是否进入下一段普通攻击
    ...
    public override void Enter()
    {
        ...
        LookToEnemy();
        playerController.PlayAnimation("Attack_Haven");
    ...
    public override void Update()
    {
        ...
        if (IsAnimationEnd())
        {
            ...
            {
                playerController.SwitchState(PlayerState.Unagi_HavenAttackEnd);
            }
