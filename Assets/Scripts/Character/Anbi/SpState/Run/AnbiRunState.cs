...
public class AnbiRunState : AnbiStateBase
{
    ...
    public override void Enter()
    {
        ...
        switch (playerModel.currentState)
        {
            case PlayerState.Walk:
                ...
                {
                    case ModelFoot.Left:
                        playerController.PlayAnimation("Walk", 0.2f, 0.6f);
                        playerModel.foot = ModelFoot.Right;
                        break;
                    case ModelFoot.Right:
                        playerController.PlayAnimation("Walk", 0.2f, 0f);
            ...
            case PlayerState.Run:
                playerController.PlayAnimation("Run", 0.2f);
                break;
        }
    }
