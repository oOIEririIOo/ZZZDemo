...
public class AnbiPerfectAttackState : AnbiStateBase
{
    //是否进入下一段普通攻击
    ...
    public override void Enter()
    {
        ...
        LookToEnemy();
        playerController.PlayAnimation("Attack_Normal_4_Perfect");
    ...
    public override void Update()
    {
        ...
        if (IsAnimationEnd())
        {
            ...
            {
                playerController.SwitchState(PlayerState.Anbi_PerfectAttack_End);
            }
